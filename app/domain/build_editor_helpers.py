...
from app.domain.artifact_effects import ARTIFACT_EFFECT_IDS_BY_ARTIFACT_TYPE
...
from app.domain.speed_ticks import max_spd_for_tick, min_spd_for_tick

if TYPE_CHECKING:
    from app.services.cloud_learning_service import BuildPreferenceTrend
