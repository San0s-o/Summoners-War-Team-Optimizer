...
STRINGS: dict[str, str] = {
    ...
    # -- Relic Übersicht -----------------------------------------
    "relic_opt.col.id": "ID",
    "relic_opt.col.main_property": "Haupteigenschaft",
    "relic_opt.col.unique_property": "Einzigartige Eigenschaft",
    "relic_opt.col.level": "Level",
    "relic_opt.col.durability": "Haltbarkeit",
    "relic_opt.col.rank": "Rang",
    "relic_opt.col.engraved": "Graviert",
    "relic_opt.filter_main": "Haupteigenschaft:",
    "relic_opt.filter_all": "Alle",
    "relic_opt.filter_reset": "Zurücksetzen",
    "relic_opt.search_placeholder": "Suche Haupteigenschaft, Eigenschaft, Monster…",
    "relic_opt.hint_no_import": "Bitte zuerst einen Account importieren.",
    "relic_opt.hint_no_rows": "Keine Relics gefunden.",
    "relic_opt.hint_no_filter_rows": "Keine Relics für den gewählten Filter.",
    "relic_opt.count": "Relics: {n}",
    "relic_opt.count_filtered": "Relics: {shown} / {total}",
    "relic_opt.main.atk": "ATK%",
    "relic_opt.main.def": "DEF%",
    "relic_opt.main.hp": "HP%",
    "relic_opt.main.unknown": "Unbekannt",
    "relic_opt.group.conquest": "Conquest",
    "relic_opt.group.resolute": "Resolute",
    "relic_opt.group.valiant": "Valiant",
    "relic_opt.group.timeless": "Timeless",
    "relic_opt.group.primal": "Primal",
    "relic_opt.group.restore": "Restore",
    "relic_opt.dep.atk": "ATK",
    "relic_opt.dep.def": "DEF",
    "relic_opt.dep.hp": "MAX HP",
    "relic_opt.dep.spd": "SPD",
    "relic_opt.dep.unknown": "Wert",
    "relic_opt.unique.conquest": "Verursachter Schaden +2% je {n} {dep} zu Kampfbeginn",
    "relic_opt.unique.resolute": "Erlittener Schaden -2% je {n} {dep} zu Kampfbeginn",
    "relic_opt.unique.valiant": "ATK +2% je {n} {dep} zu Kampfbeginn",
    "relic_opt.unique.timeless": "DEF +2% je {n} {dep} zu Kampfbeginn",
    "relic_opt.unique.primal": "MAX HP +2% je {n} {dep} zu Kampfbeginn",
    "relic_opt.unique.restore": "Heilung/Schild +2% je {n} MAX HP zu Kampfbeginn",
    "relic_opt.durability_fmt": "{cur}/3",
    "relic_opt.engraved_fmt": "{n} Monster",
    ...
    "collection.filter_missing_skillups": "Nur mit fehlenden Skillups",
    ...
    "settings.license_key_click_hint": "Auf den Key klicken, um ihn zu kopieren.",
    "settings.license_key_copied": "Lizenz-Key in die Zwischenablage kopiert.",
    ...
    "settings.desktop_mobile_sync_optin": "Desktop-zu-Mobile-Sync aktivieren (mobile Anzeige)",
    "settings.desktop_mobile_sync_optin_hint": "Nur für Vollversion: Bei Deaktivierung werden keine Desktop-Optimierungen für Mobile synchronisiert.",
    "settings.desktop_mobile_sync_optin_unavailable": "Desktop-zu-Mobile-Sync ist nur mit Vollversion verfügbar.",
    "settings.desktop_mobile_sync_saved_on": "Desktop-zu-Mobile-Sync aktiviert.",
    "settings.desktop_mobile_sync_saved_off": "Desktop-zu-Mobile-Sync deaktiviert.",
    ...
    # -- Farming-Priorität ---------------------------------------
    "tab.farming_priority": "Farming-Prio",
    "farming.btn_refresh": "Aktualisieren",
    "farming.no_runes": "Keine Runen im Account gefunden.",
    "farming.top_no_data": "Noch keine Farming-Empfehlung verfügbar.",
    "farming.summary_sets": "{sets} Sets analysiert | {runes} Runen | Ø Eff {eff}% | Ø Hero-Potenzial +{gain}%",
    "farming.sets_header": "Runen-Sets (accountweit)",
    "farming.col_set": "Set",
    "farming.col_count": "Runen",
    "farming.col_eff": "Ø Eff",
    "farming.col_hero_max": "Ø Hero Max",
    "farming.col_potential": "Potenzial",
    "farming.col_recommendation": "Empfehlung",
    "farming.reco_grinds": "Zuerst Grinds/Gems farmen ({dungeon})",
    "farming.reco_farm_set": "Set-Dungeon farmen ({dungeon})",
    "farming.reco_intangible": "Intangible ist nicht direkt farmbar (Drop aus allen Runen-Dungeons)",
    "farming.reco_ok": "Aktuell solide",
    "farming.artifacts_summary": "Artefakte: {count} analysiert | Ø Eff {eff}% (Attribut {eff_t1}% | Typ {eff_t2}%) | {recommendation}",
    "farming.artifacts_no_data": "Artefakte: keine Daten verfügbar.",
    "farming.artifacts_farm": "Artefakte farmen",
    "farming.artifacts_ok": "Artefakt-Qualität ist okay",
    "farming.top_grinds": "Top-Prio: Grind/Gem-Farming ({dungeon}) - {set_name} hat +{gain}% Ø Hero-Potenzial.",
    "farming.top_artifacts": "Top-Prio: Artefakt-Farming ({dungeon}) - Ø Artefakt-Effizienz liegt nur bei {eff}%.",
    "farming.top_set": "Top-Prio: {dungeon} farmen - {set_name} ist mit {eff}% Ø Eff dein schwächstes Set.",
    "farming.dungeon_overview_header": "Dungeon-Farming Überblick",
    "farming.dungeon_overview_header_count": "Dungeon-Farming Überblick ({count})",
    "farming.artifacts_header": "Artefakt-Status",
    "farming.artifacts_attr": "Attribut-Artefakt-Eff. (%)",
    "farming.artifacts_type": "Typ-Artefakt-Eff. (%)",
    "farming.artifacts_reco": "Empfehlung: {recommendation}",
    "farming.dungeon_note_sets": "{sets} Sets | {runes} Runen",
    "farming.dungeon_note_grinds": "Ø Grind/Gem-Potenzial +{gain}%",
    "farming.dungeon_note_artifacts": "{count} Artefakte analysiert",
    "farming.dungeon_component_quality": "Aktuelle Qualität",
    "farming.dungeon_component_potential": "Aktuell grindbares Potenzial",
    "farming.raid_breakdown": "Raid-Check",
    "farming.raid_missing": "fehlende Grinds",
    "farming.raid_one_missing": "Davon nur 1 Grind bis Hero-Max: {count}",
    "farming.dungeon_giants": "Giants",
    "farming.dungeon_dragons": "Dragons",
    "farming.dungeon_necro": "Necropolis",
    "farming.dungeon_spiritual": "Spiritual Realm",
    "farming.dungeon_steel": "Steel Fortress",
    "farming.dungeon_rift": "Rift-Dungeon",
    "farming.dungeon_punisher": "Punisher Crypt",
    "farming.dungeon_raid": "Rift-Raid",
    "farming.dungeon_artifacts": "Steel Fortress / Punisher's Crypt",
    "farming.dungeon_unknown": "Unbekannter Dungeon",
}
