...
STRINGS: dict[str, str] = {
    ...
    # -- Relic overview ------------------------------------------
    "relic_opt.col.id": "ID",
    "relic_opt.col.main_property": "Main Property",
    "relic_opt.col.unique_property": "Unique Property",
    "relic_opt.col.level": "Level",
    "relic_opt.col.durability": "Durability",
    "relic_opt.col.rank": "Rank",
    "relic_opt.col.engraved": "Engraved",
    "relic_opt.filter_main": "Main Property:",
    "relic_opt.filter_all": "All",
    "relic_opt.filter_reset": "Reset",
    "relic_opt.search_placeholder": "Search main property, unique property, monster…",
    "relic_opt.hint_no_import": "Please import an account first.",
    "relic_opt.hint_no_rows": "No relics found.",
    "relic_opt.hint_no_filter_rows": "No relics match the selected filter.",
    ...
    "relic_opt.main.unknown": "Unknown",
    ...
    "relic_opt.dep.unknown": "stat",
    "relic_opt.unique.conquest": "DMG dealt +2% per {n} {dep} at start of battle",
    "relic_opt.unique.resolute": "DMG taken -2% per {n} {dep} at start of battle",
    "relic_opt.unique.valiant": "ATK +2% per {n} {dep} at start of battle",
    "relic_opt.unique.timeless": "DEF +2% per {n} {dep} at start of battle",
    "relic_opt.unique.primal": "MAX HP +2% per {n} {dep} at start of battle",
    "relic_opt.unique.restore": "HP Recovery/Shield +2% per {n} MAX HP at start of battle",
    "relic_opt.durability_fmt": "{cur}/3",
    "relic_opt.engraved_fmt": "{n} monsters",
    ...
    "svc.auto_zip_only_frozen": "ZIP update is only available in the packaged desktop_app.",
    ...
    "svc.auto_zip_installed": "Update installed. Restarting desktop_app.",
    ...
    "settings.desktop_mobile_sync_optin": "Enable desktop-to-mobile sync (mobile view)",
    "settings.desktop_mobile_sync_optin_hint": "Full license only: when disabled, desktop optimizations are not synced to mobile.",
    "settings.desktop_mobile_sync_optin_unavailable": "Desktop-to-mobile sync is available for full licenses only.",
    "settings.desktop_mobile_sync_saved_on": "Desktop-to-mobile sync enabled.",
    "settings.desktop_mobile_sync_saved_off": "Desktop-to-mobile sync disabled.",
    ...
    # -- Farming Priority ----------------------------------------
    "tab.farming_priority": "Farming Priority",
    "farming.btn_refresh": "Refresh",
    "farming.no_runes": "No runes found in this account.",
    "farming.top_no_data": "No farming recommendation available yet.",
    "farming.summary_sets": "{sets} sets analyzed | {runes} runes | Avg Eff {eff}% | Avg Hero gain +{gain}%",
    "farming.sets_header": "Rune Sets (account-wide)",
    "farming.col_set": "Set",
    "farming.col_count": "Runes",
    "farming.col_eff": "Avg Eff",
    "farming.col_hero_max": "Avg Hero Max",
    "farming.col_potential": "Potential",
    "farming.col_recommendation": "Recommendation",
    "farming.reco_grinds": "Farm grinds/gems first ({dungeon})",
    "farming.reco_farm_set": "Farm this set dungeon ({dungeon})",
    "farming.reco_intangible": "Intangible is not directly farmable (drops from all rune dungeons)",
    "farming.reco_ok": "Good for now",
    "farming.artifacts_summary": "Artifacts: {count} analyzed | Avg Eff {eff}% (Attr {eff_t1}% | Type {eff_t2}%) | {recommendation}",
    "farming.artifacts_no_data": "Artifacts: no data available.",
    "farming.artifacts_farm": "farm artifacts",
    "farming.artifacts_ok": "artifact quality is okay",
    "farming.top_grinds": "Top priority: Grind/Gem farming ({dungeon}) - {set_name} has +{gain}% avg Hero potential.",
    "farming.top_artifacts": "Top priority: Artifact farming ({dungeon}) - avg artifact efficiency is only {eff}%.",
    "farming.top_set": "Top priority: Farm {dungeon} - {set_name} is your weakest set at {eff}% avg efficiency.",
    "farming.dungeon_overview_header": "Dungeon Farming Overview",
    "farming.dungeon_overview_header_count": "Dungeon Farming Overview ({count})",
    "farming.artifacts_header": "Artifact Status",
    "farming.artifacts_attr": "Attribute Artifact Eff. (%)",
    "farming.artifacts_type": "Type Artifact Eff. (%)",
    "farming.artifacts_reco": "Recommendation: {recommendation}",
    "farming.dungeon_note_sets": "{sets} sets | {runes} runes",
    "farming.dungeon_note_grinds": "avg grind/gem potential +{gain}%",
    "farming.dungeon_note_artifacts": "{count} artifacts analyzed",
    "farming.dungeon_component_quality": "Current quality",
    "farming.dungeon_component_potential": "Currently grindable potential",
    "farming.raid_breakdown": "Raid check",
    "farming.raid_missing": "missing grinds",
    "farming.raid_one_missing": "Only 1 grind to Hero max: {count}",
    ...
    "farming.dungeon_unknown": "Unknown Dungeon",
}
